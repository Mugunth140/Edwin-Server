...
const work_orders_controller_js_1 = require("./work-orders.controller.js");
...
exports.WorkOrdersModule = WorkOrdersModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([work_order_entity_js_1.WorkOrder, work_order_item_entity_js_1.WorkOrderItem, vendor_entity_js_1.Vendor])],
        controllers: [work_orders_controller_js_1.WorkOrdersController],
        providers: [work_orders_service_js_1.WorkOrdersService],
        exports: [work_orders_service_js_1.WorkOrdersService],
    })
], WorkOrdersModule);
